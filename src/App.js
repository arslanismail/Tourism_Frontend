        ...
        <div className="search-wrap">
          <div className="container">
            <ul className="nav nav-tabs">
              <li className="active"><a data-toggle="tab" href="#flight"><i className="flaticon-plane"></i> Flight</a></li>
              <li><a data-toggle="tab" href="#hotel"><i className="flaticon-resort"></i> Hotel</a></li>
              <li><a data-toggle="tab" href="#car"><i className="flaticon-car"></i> Car Rent</a></li>
              <li><a data-toggle="tab" href="#cruises"><i className="flaticon-boat"></i> Cruises</a></li>
            </ul>
          </div>
